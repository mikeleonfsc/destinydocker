...
REM *
REM *  process_students [intputfile] [NOCOMPARE] [NOLOAD]
REM *
...
IF "%LOGFILE%"=="" SET LOGFILE=..\automate\process_students.log
IF "%FINAL%"=="" SET FINAL=..\patdata\destiny_students.xml
IF "%PATRON_PROP%"=="" SET PATRON_PROP=map_students.properties
IF "%UPDATE%"=="" SET UPDATE=update_students.properties
IF "%SORTED%"=="" SET SORTED=..\patdata\sorted_students.csv
IF "%NOCHGXML%"=="" SET NOCHGXML=..\patdata\destiny_students_nochange.xml
IF "%NOCHGUPD%"=="" SET NOCHGUPD=update_no_change.properties
IF "%RAWFILE%"=="" SET RAWFILE=..\patdata\destiny_students.csv
...
echo Copying patron data file from %SOURCEFULLFILE% to ..\patdata\destiny_students.csv   >>%LOGFILE%
