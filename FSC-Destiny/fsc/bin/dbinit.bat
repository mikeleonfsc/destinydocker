...
echo.
echo   dbinit SQL_LOGIN, SQL_PASSWORD, {PRODUCT_MODE}, {LOG_PROP_FILE}
echo.
...
set ANT_OPTS=-DDB_USER_ARG=%1 -DDB_PASSWORD_ARG=%2 -DPRODUCT_MODE=%3 -DLOG_PROP_FILE=%4
