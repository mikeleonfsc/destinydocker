...
import com.follett.fsc.destiny.client.backoffice.servlet.DistrictInventoryProgressDetailsForm;
import com.follett.fsc.destiny.util.CollectionType;
import com.follett.fsc.destiny.session.common.SortHelper;
import com.follett.fsc.destiny.session.backoffice.data.InventoryProgressRowVO;
import org.apache.struts.util.ResponseUtils;

public final class districtinventoryprogressdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    DistrictInventoryProgressDetailsForm form = (DistrictInventoryProgressDetailsForm)request.getAttribute(DistrictInventoryProgressDetailsForm.FORM_NAME);
      ...
      // /backoffice/districtinventoryprogressdetails.jsp(22,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setAction("/backoffice/servlet/handledistrictinventoryprogressdetailsform.do");
 ...
 if (form.getPartialIDToRevive() != null) { 
          ...
          if (_jspx_eval_base_005fmessageBox_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              out.print(form.getSiteNameToRevive() );
          ...
          // /backoffice/districtinventoryprogressdetails.jsp(38,1) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f0.setProperty(DistrictInventoryProgressDetailsForm.PARAM_PARTIALID_TO_REVIVE);
          ...
          // /backoffice/districtinventoryprogressdetails.jsp(41,1) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f1.setProperty(DistrictInventoryProgressDetailsForm.PARAM_INVENTORY_ID);
          ...
          // /backoffice/districtinventoryprogressdetails.jsp(42,1) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f2.setProperty(DistrictInventoryProgressDetailsForm.PARAM_SORT);
          ...
          // /backoffice/districtinventoryprogressdetails.jsp(43,1) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f3.setProperty(DistrictInventoryProgressDetailsForm.PARAM_DESCEND);
          ...
          // /backoffice/districtinventoryprogressdetails.jsp(44,1) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f4.setProperty(DistrictInventoryProgressDetailsForm.PARAM_COLLECTION_TYPE);
          ...
          // /backoffice/districtinventoryprogressdetails.jsp(46,0) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setId(DistrictInventoryProgressDetailsForm.TABLE_MAIN);
          // /backoffice/districtinventoryprogressdetails.jsp(46,0) name = borderColor type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          ...
          if (_jspx_eval_base_005foutlinedTable_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              // /backoffice/districtinventoryprogressdetails.jsp(49,4) name = formName type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fpageListOutput_005f0.setFormName(DistrictInventoryProgressDetailsForm.FORM_NAME);
              ...
              out.write(" </td>\r\n\t    </tr>\r\n\t    <tr>\r\n\t        <td>\r\n\t\t\t\t");
              out.print(form.generateDetails());
              out.write("\r\n\t\t\t</td>\r\n\t    </tr>\r\n\t\t\r\n\t    \r\n    ");
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f0(PageContext _jspx_page_context)
    ...
    // /backoffice/districtinventoryprogressdetails.jsp(16,0) name = strutsErrors type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
