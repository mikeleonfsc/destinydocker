...
public final class enrichedcontentsetup_jsp extends org.apache.jasper.runtime.HttpJspBase
...
SessionStoreProxy store = SessionStoreProxy.getSessionStore( session, request );
      ...
      // /cataloging/enrichedcontentsetup.jsp(28,0) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setId(EnrichedContentSetupForm.TABLE_MAIN);
      // /cataloging/enrichedcontentsetup.jsp(28,0) name = selectedTab type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setSelectedTab(EnrichedContentSetupForm.ID_TAB);
      // /cataloging/enrichedcontentsetup.jsp(28,0) name = tabs type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setTabs(SearchSetupNavigationForm.getTabs(form.getSessionStore()));
      // /cataloging/enrichedcontentsetup.jsp(28,0) name = cellpadding type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setCellpadding(0);
      int _jspx_eval_base_005foutlinedTableAndTabsWithinThere_005f0 = _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.doStartTag();
      if (_jspx_eval_base_005foutlinedTableAndTabsWithinThere_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n\r\n<tr>\r\n        <td class=\"TableHeading\">");
          out.print(MessageHelper.formatMessage("enrichedcontentsetup_EnrichedContentSearchSetup") );
 ...
 if( store.canView(Permission.CAT_DIGITAL_RESOURCES_SETUP)&& form.canViewDigitalResources() ){ 
          ...
          out.print(MessageHelper.formatMessage("enrichedcontentsetup_DigitalResourcesService") );
          out.write("\r\n            ");
          if (_jspx_meth_base_005fhelpTag_005f0(_jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, _jspx_page_context))
            return;
          out.write("\r\n            </td>\r\n            <td class=\"TableHeading\">\r\n                <a id=\"");
          out.print(EnrichedContentSetupForm.LINK_EDIT_DATABASE);
          out.write("\" href=\"javascript:openWindow('");
          out.print( form.getDCPIEditURL() );
          out.write('\'');
          out.write(',');
          out.write('\'');
          out.print(EnrichedContentSetupForm.PAGE_TITLE_DCPI);
          ...
          // /cataloging/enrichedcontentsetup.jsp(49,20) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f0.setAlt(MessageHelper.formatMessage("enrichedcontentsetup_ConfigureDigitalResources") );
          // /cataloging/enrichedcontentsetup.jsp(49,20) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f0.setSrc("/buttons/large/configure.gif");
          // /cataloging/enrichedcontentsetup.jsp(49,20) name = align type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f0.setAlign("right");
          ...
          _005fjspx_005ftagPool_005fbase_005fimage_005fsrc_005falt_005falign_005fnobody.reuse(_jspx_th_base_005fimage_005f0);
          out.write("\r\n                </a>\r\n            </td>\r\n        </tr>\r\n        <tr>\r\n            <td class=\"ColRow\">");
          out.print(MessageHelper.formatMessage("enrichedcontentsetup_UseThisOptionToViewTheProvidersAndCollectionsYourSiteHasConfigured") );
          out.write("\r\n            <p>&nbsp;\r\n            </td>\r\n            <td>           \r\n                <a href=\"/cataloging/servlet/presentsetupdcpiaccessform.do\" id=\"");
          out.print(EnrichedContentSetupForm.ID_PERMISSIONS );
          out.write("\">\r\n                    ");
          //  base:image
          ...
          // /cataloging/enrichedcontentsetup.jsp(59,20) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f1.setSrc("/buttons/large/permsnarrow.gif");
          // /cataloging/enrichedcontentsetup.jsp(59,20) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f1.setAlt(MessageHelper.formatMessage("enrichedcontentsetup_ConfigurePermissions") );
          // /cataloging/enrichedcontentsetup.jsp(59,20) name = align type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f1.setAlign("right");
      ...
      if( store.canView(Permission.CAT_SETUP_ONE_SEARCH) && form.checkAllowOneSearch()){
          ...
          out.print(form.getOneSearchEditURL(true));
          out.write('\'');
          out.write(',');
          out.write('\'');
          out.print(EnrichedContentSetupForm.PAGE_TITLE_DATABASE);
          out.write("','width=800,height=600,scrollbars=1')\">\r\n                ");
          //  base:image
          ...
          // /cataloging/enrichedcontentsetup.jsp(81,16) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f2.setSrc("/buttons/large/edit.gif");
          // /cataloging/enrichedcontentsetup.jsp(81,16) name = align type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f2.setAlign("right");
          // /cataloging/enrichedcontentsetup.jsp(81,16) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f2.setAlt(EnrichedContentSetupForm.LINK_EDIT_DATABASE);
          ...
          out.print(form.getOneSearchEditURL(false));
          out.write('\'');
          out.write(',');
          out.write('\'');
          out.print(EnrichedContentSetupForm.PAGE_TITLE_SUBSRIPTION);
          ...
          // /cataloging/enrichedcontentsetup.jsp(97,16) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f3.setSrc("/buttons/large/edit.gif");
          // /cataloging/enrichedcontentsetup.jsp(97,16) name = align type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f3.setAlign("right");
          // /cataloging/enrichedcontentsetup.jsp(97,16) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f3.setAlt(EnrichedContentSetupForm.LINK_EDIT_SUBSCRIPTON);
 ...
 if( store.canView(Permission.CAT_SETUP_WEB_PATH_EXPRESS) && form.checkAllowWebPathExpressSearch()){ 
          ...
          if (_jspx_meth_base_005fhelpTag_005f2(_jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, _jspx_page_context))
            return;
          out.write("\r\n            </td>\r\n            <td class=\"TableHeading\">\r\n               <a href=\"javascript:openWindow('");
          out.print( form.getWPEEditURL());
          out.write('\'');
          out.write(',');
          out.write('\'');
          out.print(EnrichedContentSetupForm.WPE_PAGE_TITLE_SETUP);
          out.write("','width=800,height=600,scrollbars=1')\">\r\n                ");
          //  base:image
          ...
          _jspx_th_base_005fimage_005f4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0);
          // /cataloging/enrichedcontentsetup.jsp(123,16) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f4.setSrc("/buttons/large/edit.gif");
          // /cataloging/enrichedcontentsetup.jsp(123,16) name = align type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f4.setAlign("right");
          // /cataloging/enrichedcontentsetup.jsp(123,16) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f4.setAlt(EnrichedContentSetupForm.LINK_EDIT_SETUP);
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f0(PageContext _jspx_page_context)
    ...
    // /cataloging/enrichedcontentsetup.jsp(13,55) name = strutsErrors type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fimageLine_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/enrichedcontentsetup.jsp(40,8) name = height type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f0.setHeight("1");
    // /cataloging/enrichedcontentsetup.jsp(40,8) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f0.setWidth("100%");
    // /cataloging/enrichedcontentsetup.jsp(40,8) name = vspace type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fhelpTag_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/enrichedcontentsetup.jsp(45,12) name = helpFileName type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fhelpTag_005f0.setHelpFileName("t_set_up_digital_resources.htm");
  ...
  private boolean _jspx_meth_base_005fimageLine_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/enrichedcontentsetup.jsp(72,12) name = height type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f1.setHeight("1");
    // /cataloging/enrichedcontentsetup.jsp(72,12) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f1.setWidth("100%");
    // /cataloging/enrichedcontentsetup.jsp(72,12) name = vspace type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f1.setVspace("5");
  ...
  private boolean _jspx_meth_base_005fhelpTag_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/enrichedcontentsetup.jsp(77,12) name = helpFileName type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fhelpTag_005f1.setHelpFileName("t_set_up_one_search.htm");
  ...
  private boolean _jspx_meth_base_005fimageLine_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/enrichedcontentsetup.jsp(113,12) name = height type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f2.setHeight("1");
    // /cataloging/enrichedcontentsetup.jsp(113,12) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f2.setWidth("100%");
    // /cataloging/enrichedcontentsetup.jsp(113,12) name = vspace type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f2.setVspace("5");
  ...
  private boolean _jspx_meth_base_005fhelpTag_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/enrichedcontentsetup.jsp(119,12) name = helpFileName type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fhelpTag_005f2.setHelpFileName("t_set_up_webpath_express.htm");
