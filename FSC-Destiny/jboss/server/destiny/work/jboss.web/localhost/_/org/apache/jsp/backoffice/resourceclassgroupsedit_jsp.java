...
public final class resourceclassgroupsedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    ResourceClassGroupsEditForm form = (ResourceClassGroupsEditForm)request.getAttribute(ResourceClassGroupsEditForm.FORM_NAME);
      ...
      out.print(ResourceClassGroupsEditForm.FORM_NAME);
      out.write('.');
      out.print(ResourceClassGroupsEditForm.FIELD_TRAP_ENTER_PRESSED);
      out.write(".value=true;\r\n        document.");
      out.print(ResourceClassGroupsEditForm.FORM_NAME);
      out.write(".submit();\r\n      }\r\n      return true;\r\n    }\r\n    function submitOnTemplateChange() {\r\n        document.");
      out.print(ResourceClassGroupsEditForm.FORM_NAME);
      out.write('.');
      out.print(ResourceClassGroupsEditForm.FIELD_ASSET_TEMPLATE_TYPE_CHANGED);
      out.write(".value=true;\r\n        document.");
      out.print(ResourceClassGroupsEditForm.FORM_NAME);
      out.write(".submit();\r\n    }\r\n//-->\r\n</script>\r\n\r\n<br>\r\n\r\n");
      //  base:form
      ...
      // /backoffice/resourceclassgroupsedit.jsp(38,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setAction("/backoffice/servlet/handleresourceclassgroupseditform.do");
      // /backoffice/resourceclassgroupsedit.jsp(38,0) name = focus type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setFocus(ResourceClassGroupsEditForm.FIELD_SEARCH_STRING);
      ...
      if (_jspx_eval_base_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /backoffice/resourceclassgroupsedit.jsp(39,4) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f0.setProperty( ResourceClassGroupsEditForm.FIELD_TRAP_ENTER_PRESSED );
          // /backoffice/resourceclassgroupsedit.jsp(39,4) name = value type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          ...
          out.print(ResourceClassGroupsEditForm.BUTTON_TRAP_ENTER);
          out.write("\">\r\n\r\n");
          //  html:hidden
          org.apache.struts.taglib.html.HiddenTag _jspx_th_html_005fhidden_005f1 = (org.apache.struts.taglib.html.HiddenTag) _005fjspx_005ftagPool_005fhtml_005fhidden_005fproperty_005fnobody.get(org.apache.struts.taglib.html.HiddenTag.class);
          _jspx_th_html_005fhidden_005f1.setPageContext(_jspx_page_context);
          _jspx_th_html_005fhidden_005f1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_base_005fform_005f0);
          // /backoffice/resourceclassgroupsedit.jsp(42,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f1.setProperty(ResourceClassGroupsEditForm.PARM_CURRENT_SEARCH_STRING);
          ...
          // /backoffice/resourceclassgroupsedit.jsp(43,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f2.setProperty(ResourceClassGroupsEditForm.PARM_CURRENT_SEARCH_TYPE);
          ...
          // /backoffice/resourceclassgroupsedit.jsp(44,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f3.setProperty(ResourceClassGroupsEditForm.PARM_CLASS_GROUP_ID);
          ...
          // /backoffice/resourceclassgroupsedit.jsp(45,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f4.setProperty(ResourceClassGroupsEditForm.FIELD_ASSET_TEMPLATE_TYPE_CHANGED);
 ...
 if (!StringHelper.isEmpty(form.getDeleteBibMessage())) { 
          ...
          // /backoffice/resourceclassgroupsedit.jsp(47,3) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f5.setProperty( ResourceClassGroupsEditForm.PARM_REMOVE_FROM_ID);
          ...
          if (_jspx_eval_base_005fmessageBox_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              out.write("\r\n       <tr>\r\n           <td valign=\"baseline\">\r\n               ");
              out.print(form.getDeleteBibMessage() );
              out.write("\r\n               <div align=\"center\">\r\n                    ");
              //  base:yesNo
              ...
              // /backoffice/resourceclassgroupsedit.jsp(53,20) name = buttonNoName type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fyesNo_005f0.setButtonNoName(ResourceClassGroupsEditForm.BUTTON_CANCEL_DELETE);
              // /backoffice/resourceclassgroupsedit.jsp(53,20) name = buttonYesName type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fyesNo_005f0.setButtonYesName(ResourceClassGroupsEditForm.BUTTON_CONFIRM_DELETE);
          ...
          // /backoffice/resourceclassgroupsedit.jsp(59,4) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setId(ResourceClassGroupsEditForm.TABLE_UPDATE_GROUP);
          // /backoffice/resourceclassgroupsedit.jsp(59,4) name = borderColor type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          ...
          if (_jspx_eval_base_005foutlinedTable_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              // /backoffice/resourceclassgroupsedit.jsp(62,8) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_bean_005fwrite_005f0.setName( ResourceClassGroupsEditForm.FORM_NAME );
              // /backoffice/resourceclassgroupsedit.jsp(62,8) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              // /backoffice/resourceclassgroupsedit.jsp(67,13) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fokButton_005f0.setName(ResourceClassGroupsEditForm.BUTTON_CLOSE);
              ...
              // /backoffice/resourceclassgroupsedit.jsp(81,16) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_bean_005fdefine_005f0.setId("assets");
              // /backoffice/resourceclassgroupsedit.jsp(81,16) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_bean_005fdefine_005f0.setName(ResourceClassGroupsEditForm.FORM_NAME);
              // /backoffice/resourceclassgroupsedit.jsp(81,16) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
 ...
 if (form.isDisplayDropdown()) { 
              ...
              // /backoffice/resourceclassgroupsedit.jsp(85,28) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fselect_005f0.setProperty(ResourceClassGroupsEditForm.FIELD_ASSET_TEMPLATE_ID);
              // /backoffice/resourceclassgroupsedit.jsp(85,28) name = onchange type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              // /backoffice/resourceclassgroupsedit.jsp(91,24) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fhidden_005f6.setProperty( ResourceClassGroupsEditForm.FIELD_ASSET_TEMPLATE_ID );
              ...
              // /backoffice/resourceclassgroupsedit.jsp(97,20) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f0.setProperty(ResourceClassGroupsEditForm.FIELD_SEARCH_STRING);
              // /backoffice/resourceclassgroupsedit.jsp(97,20) name = size type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f0.setSize("21");
              // /backoffice/resourceclassgroupsedit.jsp(97,20) name = onkeypress type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f0.setOnkeypress("trapEnterJS(event)");
              // /backoffice/resourceclassgroupsedit.jsp(97,20) name = tabindex type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f0(PageContext _jspx_page_context)
    ...
    // /backoffice/resourceclassgroupsedit.jsp(13,0) name = strutsErrors type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fimageLine_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTable_005f0, PageContext _jspx_page_context)
    ...
    // /backoffice/resourceclassgroupsedit.jsp(72,57) name = height type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f0.setHeight("1");
    // /backoffice/resourceclassgroupsedit.jsp(72,57) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_html_005foptions_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, PageContext _jspx_page_context)
    ...
    // /backoffice/resourceclassgroupsedit.jsp(86,32) name = collection type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_html_005foptions_005f0.setCollection("assets");
    // /backoffice/resourceclassgroupsedit.jsp(86,32) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_html_005foptions_005f0.setProperty("longID");
    // /backoffice/resourceclassgroupsedit.jsp(86,32) name = labelProperty type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fgoButton_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTable_005f0, PageContext _jspx_page_context)
    ...
    // /backoffice/resourceclassgroupsedit.jsp(99,19) name = absbottom type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
