...
import com.follett.fsc.destiny.client.cataloging.servlet.OrderNotesViewForm;
import com.follett.fsc.destiny.session.cataloging.data.OrderNoteClientVO;
import java.util.Iterator;
import com.follett.fsc.destiny.entity.ejb3.OrderNoteVO;
import org.apache.struts.util.ResponseUtils;
import com.follett.fsc.destiny.client.cataloging.servlet.OrderNotesViewForm.Note;
import com.follett.fsc.common.consortium.UserContext;

public final class ordernotesview_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if ( !form.isReadOnly() ) {
      ...
      // /cataloging/ordernotesview.jsp(26,64) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setAction("/cataloging/servlet/handleordernotesviewform.do");
      // /cataloging/ordernotesview.jsp(26,64) name = focus type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setFocus(focusControl);
      // /cataloging/ordernotesview.jsp(26,64) name = enctype type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      ...
      if (_jspx_eval_base_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /cataloging/ordernotesview.jsp(27,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f0.setProperty( OrderNotesViewForm.PARAM_ORDER_ID );
          ...
          // /cataloging/ordernotesview.jsp(28,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f1.setProperty( OrderNotesViewForm.PARAM_TRANSFER_TYPE );
          ...
          // /cataloging/ordernotesview.jsp(30,0) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setId(OrderNotesViewForm.TABLE_MAIN);
          // /cataloging/ordernotesview.jsp(30,0) name = borderColor type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setBorderColor(FlipperTag.ROW_GRAY);
          // /cataloging/ordernotesview.jsp(30,0) name = align type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setAlign("center");
          // /cataloging/ordernotesview.jsp(30,0) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
 ...
 if (!form.isReadOnly()) { 
              ...
              // /cataloging/ordernotesview.jsp(39,16) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftextarea_005f0.setProperty(OrderNotesViewForm.FIELD_NOTE);
              // /cataloging/ordernotesview.jsp(39,16) name = rows type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftextarea_005f0.setRows("2");
              // /cataloging/ordernotesview.jsp(39,16) name = cols type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              // /cataloging/ordernotesview.jsp(40,16) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setSrc("/buttons/small/add.gif");
              // /cataloging/ordernotesview.jsp(40,16) name = absbottom type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setAbsbottom(false);
              // /cataloging/ordernotesview.jsp(40,16) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setAlt(OrderNotesViewForm.ALT_ADD_NOTE);
              // /cataloging/ordernotesview.jsp(40,16) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setName(OrderNotesViewForm.BUTTON_ADD);
  ...
  if(form.getNotes().size() > 0) {
    ...
    while (iter.hasNext()) {
       ...
       if (counter % 2 == 0) {
              ...
              out.print(UserContext.getMyContextLocaleHelper().formatDate(rec.getCreated()) );
              out.write(' ');
              out.write('-');
              out.write(' ');
              out.print( ResponseUtils.filter(rec.getSiteName()) );
              out.write("</b> (");
              out.print( ResponseUtils.filter(rec.getUserName()) );
              out.write(')');
              out.write(':');
              out.write(' ');
              out.print( ResponseUtils.filter(rec.getNoteText()) );
              out.write("\r\n        </td>\r\n    </tr>\r\n    ");
 counter++; 
              out.write('\r');
              out.write('\n');
  ...
  private boolean _jspx_meth_base_005fcloseButton_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTable_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/ordernotesview.jsp(43,16) name = absbottom type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fcloseButton_005f0.setAbsbottom(true);
    // /cataloging/ordernotesview.jsp(43,16) name = withX type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fcloseButton_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTable_005f0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  base:closeButton
    com.follett.fsc.destiny.client.common.jsptag.buttons.CloseButtonTag _jspx_th_base_005fcloseButton_005f1 = (com.follett.fsc.destiny.client.common.jsptag.buttons.CloseButtonTag) _005fjspx_005ftagPool_005fbase_005fcloseButton_005fwithX_005fabsbottom_005fnobody.get(com.follett.fsc.destiny.client.common.jsptag.buttons.CloseButtonTag.class);
    ...
    // /cataloging/ordernotesview.jsp(52,16) name = absbottom type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fcloseButton_005f1.setAbsbottom(true);
    // /cataloging/ordernotesview.jsp(52,16) name = withX type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    ...
    if (_jspx_th_base_005fcloseButton_005f1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _005fjspx_005ftagPool_005fbase_005fcloseButton_005fwithX_005fabsbottom_005fnobody.reuse(_jspx_th_base_005fcloseButton_005f1);
      return true;
    }
    _005fjspx_005ftagPool_005fbase_005fcloseButton_005fwithX_005fabsbottom_005fnobody.reuse(_jspx_th_base_005fcloseButton_005f1);
    return false;
