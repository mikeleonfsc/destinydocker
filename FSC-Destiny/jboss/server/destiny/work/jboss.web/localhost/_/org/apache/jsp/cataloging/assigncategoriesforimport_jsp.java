...
import com.follett.fsc.destiny.client.cataloging.servlet.AssignCategoriesForImportForm;
import org.apache.struts.util.ResponseUtils;
import com.follett.fsc.destiny.util.lookup.LongStringLookup;
import com.follett.fsc.common.MessageHelper;
import com.follett.fsc.common.LocaleHelper;

public final class assigncategoriesforimport_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /cataloging/assigncategoriesforimport.jsp(23,0) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_bean_005fdefine_005f0.setId("form");
      // /cataloging/assigncategoriesforimport.jsp(23,0) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_bean_005fdefine_005f0.setName("cataloging_servlet_AssignCategoriesForImportForm");
      // /cataloging/assigncategoriesforimport.jsp(23,0) name = type type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_bean_005fdefine_005f0.setType("AssignCategoriesForImportForm");
      ...
      _005fjspx_005ftagPool_005fbean_005fdefine_005ftype_005fname_005fid_005fnobody.reuse(_jspx_th_bean_005fdefine_005f0);
      AssignCategoriesForImportForm form = null;
      form = (AssignCategoriesForImportForm) _jspx_page_context.findAttribute("form");
      out.write('\r');
      out.write('\n');
 form.resetFlipper(); 
      out.write('\r');
      ...
      // /cataloging/assigncategoriesforimport.jsp(25,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setAction("/cataloging/servlet/handleassigncategoriesforimportform.do");
      ...
      if (_jspx_eval_base_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /cataloging/assigncategoriesforimport.jsp(26,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f0.setProperty(AssignCategoriesForImportForm.PARM_SITEID);
          ...
          _005fjspx_005ftagPool_005fhtml_005fhidden_005fproperty_005fnobody.reuse(_jspx_th_html_005fhidden_005f0);
          out.write("\r\n<table id=\"");
          out.print(AssignCategoriesForImportForm.TABLE_ASSIGN_CATS_CATEGORY);
          out.write("\" border=\"0\" cellpadding=\"3\" cellspacing=\"0\">\r\n<tr>\r\n\r\n");

    if (form.getCategoryList().size() > 0) {

          out.write("\r\n    <td class=\"SmallColHeading\">");
          out.print( MessageHelper.formatMessage("assigncategoriesforimport_CategoryDescription") );
          out.write("</td>\r\n    <td>&nbsp;</td>\r\n    <td class=\"SmallColHeading\">");
          out.print( MessageHelper.formatMessage("assigncategoriesforimport_Assigned") );
          out.write("</td>\r\n");
        ...
        out.println("<td colspan=\"3\" align=\"center\" class=\"ColRowBold\">"+ MessageHelper.formatMessage("assigncategoriesforimport_ThereAreNoCategoriesForThisSite") +"</td>");
          ...
          // /cataloging/assigncategoriesforimport.jsp(43,0) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_logic_005fiterate_005f0.setId("categoryItem");
          // /cataloging/assigncategoriesforimport.jsp(43,0) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_logic_005fiterate_005f0.setName("cataloging_servlet_AssignCategoriesForImportForm");
          // /cataloging/assigncategoriesforimport.jsp(43,0) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_logic_005fiterate_005f0.setProperty("categoryList");
          // /cataloging/assigncategoriesforimport.jsp(43,0) name = type type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          ...
          if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            com.follett.fsc.destiny.util.lookup.LongStringLookup categoryItem = null;
            if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
              out = _jspx_page_context.pushBody();
              _jspx_th_logic_005fiterate_005f0.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
              _jspx_th_logic_005fiterate_005f0.doInitBody();
            }
            categoryItem = (com.follett.fsc.destiny.util.lookup.LongStringLookup) _jspx_page_context.findAttribute("categoryItem");
            do {
              out.write("\r\n    ");
              out.print( form.getFlipper() );
              out.write("\r\n        <td class=\"ColRow\">\r\n            ");
              out.print( ResponseUtils.filter(categoryItem.getStringDesc() ));
              out.write("\r\n        </td>\r\n        <td>");
              ...
              // /cataloging/assigncategoriesforimport.jsp(50,12) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fmultibox_005f0.setProperty( AssignCategoriesForImportForm.FIELD_SELECTED_CATEGORIES );
              ...
              if (_jspx_eval_html_005fmultibox_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  out.write("\r\n            ");
                  out.print( categoryItem.getLongID().toString() );
                  out.write("\r\n            ");
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f0(PageContext _jspx_page_context)
    ...
    // /cataloging/assigncategoriesforimport.jsp(22,0) name = strutsErrors type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fimageSpacer_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/assigncategoriesforimport.jsp(48,12) name = width type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageSpacer_005f0.setWidth(100);
    // /cataloging/assigncategoriesforimport.jsp(48,12) name = height type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
