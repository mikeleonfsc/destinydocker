...
public final class editstateoptions_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.print(EditStateOptionsForm.getLastBackupDisplayMsg(false));
      ...
      // /district/editstateoptions.jsp(23,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setAction("/district/servlet/handleeditstateoptionsform.do");
      // /district/editstateoptions.jsp(23,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      ...
      if (_jspx_eval_base_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /district/editstateoptions.jsp(24,2) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setId(EditStateOptionsForm.TABLE_DISTRICT_EDIT);
          // /district/editstateoptions.jsp(24,2) name = selectedTab type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setSelectedTab(EditStateOptionsForm.TAB);
          // /district/editstateoptions.jsp(24,2) name = tabs type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setTabs(DistrictTabHelper.getDisplayableTabs(store));
          // /district/editstateoptions.jsp(24,2) name = align type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setAlign("center");
          // /district/editstateoptions.jsp(24,2) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          ...
          if (_jspx_eval_base_005foutlinedTableAndTabsWithinThere_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              out.print(EditStateOptionsForm.TABLE_STATE_FINE_SCHEDULE);
              out.write("\" border=\"0\" cellspacing=\"0\" cellpadding=\"3\" align=\"center\" width=\"400\">\r\n                <tr>\r\n                    <td class=\"ColRowBold\">If copy's age is</td>\r\n                    <td class=\"ColRowBold\">Percentage applied will be</td>\r\n                </tr>\r\n                ");
              //  logic:iterate
              ...
              // /district/editstateoptions.jsp(38,16) name = indexId type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_logic_005fiterate_005f0.setIndexId("count");
              // /district/editstateoptions.jsp(38,16) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_logic_005fiterate_005f0.setId("scheduleEntry");
              // /district/editstateoptions.jsp(38,16) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_logic_005fiterate_005f0.setName( EditStateOptionsForm.FORM_NAME );
              // /district/editstateoptions.jsp(38,16) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_logic_005fiterate_005f0.setProperty("fineScheduleList");
              // /district/editstateoptions.jsp(38,16) name = type type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                com.follett.fsc.destiny.util.lookup.LongStringLookup scheduleEntry = null;
                ...
                scheduleEntry = (com.follett.fsc.destiny.util.lookup.LongStringLookup) _jspx_page_context.findAttribute("scheduleEntry");
                count = (java.lang.Integer) _jspx_page_context.findAttribute("count");
                do {
                  out.write("\r\n                    <tr>\r\n                        <td class=\"ColRow\" valign=\"top\">\r\n                            ");
                  out.print( scheduleEntry.getStringDesc() );
                  out.write("\r\n                        </td>\r\n                        <td class=\"ColRow\" valign=\"top\">\r\n                            ");
                  out.print( scheduleEntry.getLongID().toString() );
                  out.write("%\r\n                        </td>\r\n                    </tr>\r\n                ");
              ...
              _005fjspx_005ftagPool_005flogic_005fiterate_005ftype_005fproperty_005fname_005findexId_005fid.reuse(_jspx_th_logic_005fiterate_005f0);
              out.write("\r\n                <tr>\r\n                    <td colspan=\"2\">&nbsp;</td>\r\n                </tr>\r\n                <tr>\r\n                    <td colspan=\"2\" class=\"ColRow\">* An age of 0 years denotes within current school year.</td>\r\n                </tr>\r\n                <tr>\r\n                    <td colspan=\"2\">&nbsp;</td>\r\n                </tr>\r\n                <tr>\r\n                    <td class=\"ColRowBold tdAlignRight\">Contract month:</td><td class=\"ColRow\">");
              out.print( form.getFineScheduleMonth() );
              out.write("</td>\r\n                </tr>\r\n            </table>\r\n        </td>\r\n    </tr>\r\n\r\n    <tr><td>&nbsp;</td></tr>\r\n\r\n    ");
              ...
              // /district/editstateoptions.jsp(72,12) name = page type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005flink_005f0.setPage("/common/servlet/presenteditsmtpoptionsform.do?districtMode=true");
              // /district/editstateoptions.jsp(72,12) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005flink_005f0.setId(EditStateOptionsForm.ID_BUTTON_SMTP_OPTIONS );
              ...
              if (_jspx_eval_base_005flink_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  // /district/editstateoptions.jsp(73,16) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005fimage_005f0.setSrc("/buttons/large/edit.gif");
                  // /district/editstateoptions.jsp(73,16) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005fimage_005f0.setAlt(EditStateOptionsForm.ALT_BUTTON_SMTP_OPTIONS );
                  // /district/editstateoptions.jsp(73,16) name = align type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              // /district/editstateoptions.jsp(83,12) name = page type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005flink_005f1.setPage("/common/servlet/presenteditpasswordpoliciesform.do");
              // /district/editstateoptions.jsp(83,12) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005flink_005f1.setId(DistrictOptionsForm.ID_BUTTON_PASSWORD_POLICIES );
              ...
              if (_jspx_eval_base_005flink_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  // /district/editstateoptions.jsp(84,16) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005fimage_005f1.setSrc("/buttons/large/edit.gif");
                  // /district/editstateoptions.jsp(84,16) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005fimage_005f1.setAlt(DistrictOptionsForm.ALT_BUTTON_PASSWORD_POLICIES );
                  // /district/editstateoptions.jsp(84,16) name = align type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f0(PageContext _jspx_page_context)
    ...
    // /district/editstateoptions.jsp(18,0) name = strutsErrors type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
