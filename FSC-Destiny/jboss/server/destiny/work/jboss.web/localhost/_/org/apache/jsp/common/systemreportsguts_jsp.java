...
import com.follett.fsc.destiny.client.backoffice.servlet.ReportMenuTabForm;

public final class systemreportsguts_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (form == null) {
      ...
      // /common/systemreportsguts.jsp(20,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_c_005fset_005f0.setVar("form");
      // /common/systemreportsguts.jsp(20,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      ...
      out.print( MessageHelper.formatMessage("systemreportsguts_SystemHealthReports") );
      out.write("&nbsp;</span>\r\n        </td>\r\n        <td height=\"18\">\r\n            ");
      //  base:link
      ...
      // /common/systemreportsguts.jsp(27,12) name = page type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005flink_005f0.setPage("/common/servlet/presentsystemhealthreportsform.do");
      ...
      if (_jspx_eval_base_005flink_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          // /common/systemreportsguts.jsp(28,16) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f0.setSrc("/buttons/large/runreport.gif");
          // /common/systemreportsguts.jsp(28,16) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f0.setName(SystemReportsForm.BUTTON_NEW_SYSTEM_HEALTH_REPORT );
          // /common/systemreportsguts.jsp(28,16) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f0.setAlt(MessageHelper.formatMessage("runReport") );
          // /common/systemreportsguts.jsp(28,16) name = align type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      ...
      out.print( MessageHelper.formatMessage("systemreportsguts_ThisOptionLetsYouSee") );
      out.write("\r\n            <br>\r\n            ");
      //  c:choose
      ...
      if (_jspx_eval_c_005fchoose_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /common/systemreportsguts.jsp(37,16) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_c_005fwhen_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${form.perfDataUploading}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
          int _jspx_eval_c_005fwhen_005f0 = _jspx_th_c_005fwhen_005f0.doStartTag();
          if (_jspx_eval_c_005fwhen_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              out.write("\r\n                    ");
              out.print( MessageHelper.formatMessage("systemreportsguts_Sending") );
              out.write("\r\n                ");
          ...
          if (_jspx_eval_c_005fotherwise_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              out.write("\r\n                     ");
              out.print( MessageHelper.formatMessage("systemreportsguts_NotSending") );
              out.write("\r\n                ");
      ...
      _005fjspx_005ftagPool_005fc_005fchoose.reuse(_jspx_th_c_005fchoose_005f0);
      out.write("\r\n            ");
      out.print( MessageHelper.formatMessage("systemreportsguts_DestinyServeStatisticalInformation") );
      out.write("\r\n            ");
      //  base:link
      ...
      // /common/systemreportsguts.jsp(45,12) name = href type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005flink_005f1.setHref("/common/servlet/presentsystemhealthreportoptionsform.do");
      ...
      if (_jspx_eval_base_005flink_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          // /common/systemreportsguts.jsp(46,20) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f1.setSrc("/icons/general/edit.gif");
          // /common/systemreportsguts.jsp(46,20) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005fimage_005f1.setAlt(MessageHelper.formatMessage("systemreportsguts_EditReportOptions") );
          // /common/systemreportsguts.jsp(46,20) name = align type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
