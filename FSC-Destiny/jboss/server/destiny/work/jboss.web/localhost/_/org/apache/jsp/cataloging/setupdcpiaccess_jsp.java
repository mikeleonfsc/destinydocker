...
import com.follett.fsc.destiny.client.cataloging.servlet.SetupDcpiAccessForm;
import com.follett.fsc.destiny.session.cataloging.data.DcpiSetupAccessVO;
...
public final class setupdcpiaccess_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
   ...
   SetupDcpiAccessForm form = (SetupDcpiAccessForm)request.getAttribute(SetupDcpiAccessForm.FORM_NAME); 
      ...
      // /cataloging/setupdcpiaccess.jsp(33,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setAction("/cataloging/servlet/handlesetupdcpiaccessform.do");
      ...
      if (_jspx_eval_base_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /cataloging/setupdcpiaccess.jsp(35,0) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setId(SetupDcpiAccessForm.TABLE_MAIN);
          // /cataloging/setupdcpiaccess.jsp(35,0) name = borderColor type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setBorderColor("#C0C0C0");
          // /cataloging/setupdcpiaccess.jsp(35,0) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setWidth("98%");
          // /cataloging/setupdcpiaccess.jsp(35,0) name = cellpadding type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setCellpadding(5);
          // /cataloging/setupdcpiaccess.jsp(35,0) name = cellspacing type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setCellspacing(0);
          int _jspx_eval_base_005foutlinedTable_005f0 = _jspx_th_base_005foutlinedTable_005f0.doStartTag();
          if (_jspx_eval_base_005foutlinedTable_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              out.write("\r\n    <tr><td colspan=\"4\" class=\"TableHeading\">");
              out.print(MessageHelper.formatMessage("setupdcpiaccess_SetupDigitalResourceAccess") );
              out.write("</td></tr>\r\n    ");
 
        List<DcpiSetupAccessVO> list = form.gimmeVOList();
        if ( list.size() == 0 ) { 
              out.write("\r\n            <tr>\r\n                <td colspan=\"3\" class=\"SmallColHeading\" align=\"center\" valign=\"middle\">\r\n                    ");
              out.print(MessageHelper.formatMessage("setupdcpiaccess_ThereAreNoDigitalResourceProvidersAvailable"));
              out.write("\r\n                </td>\r\n            </tr>        \r\n            <tr>\r\n                <td colspan=\"3\" class=\"SmallColHeading\" align=\"center\" valign=\"middle\">\r\n                    <a id=\"");
              out.print( SetupDcpiAccessForm.LINK_SETUP_DCPI);
              ...
              // /cataloging/setupdcpiaccess.jsp(48,24) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fimage_005f0.setSrc("/icons/general/edit.gif");
              // /cataloging/setupdcpiaccess.jsp(48,24) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fimage_005f0.setAlt(SetupDcpiAccessForm.ALT_SETUP_DCPI);
              ...
              _005fjspx_005ftagPool_005fbase_005fimage_005fsrc_005falt_005fnobody.reuse(_jspx_th_base_005fimage_005f0);
              out.write("\r\n                        ");
              out.print(MessageHelper.formatMessage("setupdcpiaccess_SetUpDigitalResourceProviders") );
              out.write("\r\n                    </a>\r\n                </td>\r\n            </tr>\r\n        ");
 } else { 
              out.write("\r\n            ");
if(form.getExpandedSection() != null){
              out.write("\r\n                <tr>\r\n                <td class=\"ColRow\">&nbsp;</td>\r\n                <td class=\"ColRowBold\" align=\"center\">");
              out.print(MessageHelper.formatMessage("setupdcpiaccess_Staff"));
              out.write("</td>\r\n                <td class=\"ColRowBold\" align=\"center\">");
              out.print(MessageHelper.formatMessage("setupdcpiaccess_Student"));
              out.write("</td>\r\n                <td class=\"ColRowBold\" align=\"center\">");
              out.print(MessageHelper.formatMessage("setupdcpiaccess_Guest"));
              out.write("</td>\r\n                </tr>\r\n            ");
} 
              out.write("\r\n            ");
              ...
              // /cataloging/setupdcpiaccess.jsp(66,20) name = key type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fflipper_005f0.setKey("dcpisetup");
 ...
 if(vo.getMemberName() != null && vo.getName() == null){ 
                  ...
                  out.print(form.getCollapsibleControls(vo.getMemberGUID(), vo.getMemberGUID().equals(form.getExpandedSection()) ) );
                  out.write("                    \r\n                                ");
                  out.print(ResponseUtils.filter(vo.getMemberName()) );
                  out.write("\r\n                            </td>\r\n                        ");
}else{
                  out.write("\r\n                        ");
                  out.print(JSPHelper.renderHidden(SetupDcpiAccessForm.FIELD_HIDDEN_GUID, vo.getGUID()) );
                  out.write("\r\n                        ");
if(vo.getMemberGUID().equals(form.getExpandedSection())){
                  out.write("\r\n                            <td class=\"ColRowBold\">&nbsp;&nbsp;&nbsp;");
                  out.print(ResponseUtils.filter(vo.getName()) );
                  out.write("\r\n                            <td class=\"ColRowBold\" align=\"center\">");
                  out.print(JSPHelper.renderCheckbox(SetupDcpiAccessForm.FIELD_PREFIX_STAFF + vo.getGUID(), vo.isAllowStaff()));
                  out.write("\r\n                            <td class=\"ColRowBold\" align=\"center\">");
                  out.print(JSPHelper.renderCheckbox(SetupDcpiAccessForm.FIELD_PREFIX_STUDENT + vo.getGUID(), vo.isAllowStudent()));
                  out.write("\r\n                            <td class=\"ColRowBold\" align=\"center\">");
                  out.print(JSPHelper.renderCheckbox(SetupDcpiAccessForm.FIELD_PREFIX_GUEST + vo.getGUID(), vo.isAllowGuest()));
                  out.write("\r\n                            ");
}else{ 
                  out.write("\r\n                            ");
                  out.print(JSPHelper.renderHidden(SetupDcpiAccessForm.FIELD_PREFIX_STAFF + vo.getGUID(), new Boolean(vo.isAllowStaff())) );
                  out.write("\r\n                            ");
                  out.print(JSPHelper.renderHidden(SetupDcpiAccessForm.FIELD_PREFIX_STUDENT + vo.getGUID(), new Boolean(vo.isAllowStudent())) );
                  out.write("\r\n                            ");
                  out.print(JSPHelper.renderHidden(SetupDcpiAccessForm.FIELD_PREFIX_GUEST + vo.getGUID(), new Boolean(vo.isAllowGuest())) );
                  out.write("\r\n                            ");
 } 
                  out.write("\r\n                        ");
} 
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f0(PageContext _jspx_page_context)
    ...
    // /cataloging/setupdcpiaccess.jsp(31,94) name = strutsErrors type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fsaveButton_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005fshowHideTag_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/setupdcpiaccess.jsp(96,24) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
