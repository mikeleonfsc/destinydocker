...
import com.follett.fsc.destiny.client.cataloging.servlet.ScheduleAssetImportForm;
import java.util.*;
...
public final class scheduleassetimport_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    String focusControl = "";
      ...
      out.print(ScheduleAssetImportForm.FORM_NAME);
      out.write('.');
      out.print(ScheduleAssetImportForm.FIELD_FILE_CHANGED);
      ...
      // /cataloging/scheduleassetimport.jsp(63,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setAction("/cataloging/servlet/handlescheduleassetimportform.do");
      // /cataloging/scheduleassetimport.jsp(63,0) name = enctype type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setEnctype("multipart/form-data");
      // /cataloging/scheduleassetimport.jsp(63,0) name = focus type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      ...
      if (_jspx_eval_base_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /cataloging/scheduleassetimport.jsp(66,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f0.setProperty( ScheduleAssetImportForm.FIELD_JOB_SPEC_ID );
          ...
          // /cataloging/scheduleassetimport.jsp(67,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f1.setProperty( ScheduleAssetImportForm.FIELD_FILE_CHANGED );
          ...
          // /cataloging/scheduleassetimport.jsp(68,0) name = selectedTab type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setSelectedTab(form.getSelectedTab());
          // /cataloging/scheduleassetimport.jsp(68,0) name = tabs type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setTabs(form.getTabs());
          // /cataloging/scheduleassetimport.jsp(68,0) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setId(AssetImportForm.TABLE_OUTLINE_IMPORT_ASSET);
          // /cataloging/scheduleassetimport.jsp(68,0) name = borderColor type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          ...
          if (_jspx_eval_base_005foutlinedTableAndTabsWithinThere_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              out.print(form.ID_PAGE_MAIN_HEADING_LABEL);
              out.write("\">\r\n            ");
              out.print(form.getFormHeading() );
              out.write("\r\n        </td>\r\n    </tr>\r\n    <tr>\r\n        <td>\r\n            <table id=\"");
              out.print(ScheduleAssetImportForm.EMBEDDED_TABLE);
              out.write("\" align=\"center\" width=\"95%\">\r\n                <tr>\r\n                    <td class=\"ColRowBold tdAlignRight\" id=\"");
              out.print(form.ID_JOB_NAME_LABEL);
              out.write("\" nowrap=\"true\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_JobName"));
              out.write("\r\n                    </td>\r\n                    <td id=\"");
              out.print(form.ID_JOB_NAME_EDIT_BOX);
              out.write("\">\r\n                        ");
              //  html:text
              ...
              // /cataloging/scheduleassetimport.jsp(82,24) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f0.setProperty(form.FIELD_CUSTOM_JOB_NAME );
              // /cataloging/scheduleassetimport.jsp(82,24) name = size type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f0.setSize("50");
              // /cataloging/scheduleassetimport.jsp(82,24) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              if (_jspx_meth_base_005fimageLine_005f0(_jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, _jspx_page_context))
                return;
              out.write("</td>\r\n                </tr> \r\n                <tr>\r\n                    <td colspan=\"2\" class=\"TableHeading2\" id=\"");
              out.print(form.ID_XML_FILE_HEADING_LABEL);
              out.write("\" nowrap=\"true\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_ImportAssetItemsXMLFile"));
              out.write("\r\n                    </td>\r\n                </tr>           \r\n                <tr>\r\n                    <td class=\"ColRowBold tdAlignRight\" id=\"");
              out.print(form.ID_XML_FILE_DIRECTORY_LABEL);
              out.write("\" nowrap=\"true\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_ServerSideDirectory"));
              out.write("\r\n                    </td>\r\n                    <td>\r\n                        ");
              //  html:text
              ...
              // /cataloging/scheduleassetimport.jsp(98,24) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f1.setProperty( ScheduleAssetImportForm.FIELD_XML_FILE_DIRECTORY );
              // /cataloging/scheduleassetimport.jsp(98,24) name = size type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f1.setSize("50");
              // /cataloging/scheduleassetimport.jsp(98,24) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              _005fjspx_005ftagPool_005fhtml_005ftext_005fsize_005fproperty_005fmaxlength_005fnobody.reuse(_jspx_th_html_005ftext_005f1);
              out.write("\r\n                    </td>\r\n                </tr>\r\n                <tr>\r\n                    <td class=\"ColRowBold tdAlignRight\" id=\"");
              out.print(form.ID_XML_FILE_NAME_LABEL);
              out.write("\" nowrap=\"true\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_XmlFileName"));
              out.write("\r\n                    </td>\r\n                    <td>\r\n                        ");
              //  html:text
              ...
              // /cataloging/scheduleassetimport.jsp(106,24) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f2.setProperty( ScheduleAssetImportForm.FIELD_XML_FILE_NAME );
              // /cataloging/scheduleassetimport.jsp(106,24) name = size type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f2.setSize("50");
              // /cataloging/scheduleassetimport.jsp(106,24) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              _005fjspx_005ftagPool_005fhtml_005ftext_005fsize_005fproperty_005fmaxlength_005fnobody.reuse(_jspx_th_html_005ftext_005f2);
              out.write("\r\n                    </td>\r\n                </tr>\r\n                <tr>\r\n                    <td class=\"ColRowBold tdAlignRight\" id=\"");
              out.print(form.ID_XML_FILE_ENCODING_LABEL);
              out.write("\" nowrap=\"true\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_FileEncoding") );
              out.write("\r\n                    </td>\r\n                    <td class=\"ColRow\">\r\n                        ");
              out.print( form.getFileEncodingDisplayable() );
              out.write("\r\n                    </td>\r\n                </tr>\r\n                <tr>\r\n                    <td class=\"Instruction\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_RequiredField") );
              out.write("\r\n                    </td>\r\n                    <td class=\"ColRow tdAlignRight\">\r\n                        &nbsp;\r\n                    </td>                 \r\n                </tr>\r\n                <tr>\r\n                    <td colspan=\"2\">");
              if (_jspx_meth_base_005fimageLine_005f1(_jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, _jspx_page_context))
                return;
              out.write("</td>\r\n                </tr> \r\n                <tr>\r\n                    <td colspan=\"2\" class=\"TableHeading2\" id=\"");
              out.print(form.ID_JOB_SCHEDULE_HEADING_LABEL);
              out.write("\" nowrap=\"true\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_JobSchedule") );
              out.write("\r\n                    </td>\r\n                </tr>                        \r\n                <tr>\r\n                    <td class=\"ColRowBold tdAlignRight\" id=\"");
              out.print(form.ID_DAY_OF_THE_WEEK_LABEL);
              out.write("\">\r\n                        &nbsp;\r\n                    </td>\r\n                    <td>\r\n                        <table>\r\n                            <tr>\r\n                                <td class=\"ColRow\" >\r\n                                    <table>\r\n                                    ");
 for (int x = 0; x < 7; x++) { 
              out.write("\r\n                                        <tr>\r\n                                            <td>\r\n                                                ");
              //  html:checkbox
              ...
              // /cataloging/scheduleassetimport.jsp(145,48) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fcheckbox_005f0.setProperty(form.getPropertyForDay(x, firstDay));
              ...
              out.write("\r\n                                    </table>                               \r\n                                </td>\r\n                            </tr>\r\n                        </table>\r\n                    </td>\r\n                </tr>            \r\n                <tr>\r\n                    <td class=\"ColRowBold tdAlignRight\" id=\"");
              out.print(form.ID_TIME_LABEL);
              out.write("\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_Time") );
              out.write("\r\n                    </td>\r\n                    <td>\r\n                         ");
              //  html:text
              ...
              // /cataloging/scheduleassetimport.jsp(160,25) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f3.setProperty(form.FIELD_TIME_TO_RUN );
              // /cataloging/scheduleassetimport.jsp(160,25) name = size type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f3.setSize("12");
              // /cataloging/scheduleassetimport.jsp(160,25) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              out.print(MessageHelper.formatMessage("scheduleassetimport_ExampleTimePm") );
              out.write("</span>\r\n                    </td>\r\n                </tr>    \r\n                <tr>\r\n                    <td colspan=\"2\">");
              if (_jspx_meth_base_005fimageLine_005f2(_jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, _jspx_page_context))
                return;
              out.write("</td>\r\n                </tr> \r\n                <tr>\r\n                    <td class=\"TableHeading2\" colspan=\"2\" id=\"");
              out.print(form.ID_JOB_OPTIONS_HEADING_LABEL);
              out.write("\" nowrap=\"true\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_JobOptions") );
              out.write("\r\n                    </td>\r\n                </tr>                         \r\n                <tr>\r\n                    <td class=\"FormLabel\" id=\"");
              out.print(form.ID_ASSET_MATCHING_LABEL);
              out.write("\" nowrap=\"true\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_AssetMatching") );
              out.write("\r\n                    </td>\r\n                    <td class=\"ColRow tdAlignRight\">\r\n                        &nbsp;\r\n                    </td>               \r\n                </tr>\r\n                <tr>\r\n                    <td class=\"FormLabel\" id=\"");
              out.print(form.ID_ASSET_MATCHING_INSTRUCTION_LABEL);
              out.write("\" colspan=\"2\" nowrap=\"true\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_IfAnIncomingAssetMatchesAnExistingAsset") );
              ...
              // /cataloging/scheduleassetimport.jsp(189,24) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fradio_005f0.setProperty(form.FIELD_SKIP_DUPLICATE_ASSETS);
              // /cataloging/scheduleassetimport.jsp(189,24) name = value type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fradio_005f0.setValue(form.VALUE_SKIP_ASSET);
              ...
              _005fjspx_005ftagPool_005fhtml_005fradio_005fvalue_005fproperty_005fnobody.reuse(_jspx_th_html_005fradio_005f0);
              out.write("\r\n                    </td>\r\n                    <td class=\"FormElement\" id=\"");
              out.print(form.ID_ASSET_MATCHING_SKIP_LABEL);
              out.write("\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_SkipTheIncomingAsset") );
              out.write("\r\n                    </td>\r\n                </tr>\r\n                <tr>\r\n                    <td class=\"FormElement tdAlignRight\">\r\n                        ");
              //  html:radio
              ...
              // /cataloging/scheduleassetimport.jsp(197,24) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fradio_005f1.setProperty(form.FIELD_SKIP_DUPLICATE_ASSETS);
              // /cataloging/scheduleassetimport.jsp(197,24) name = value type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fradio_005f1.setValue( form.VALUE_REPLACE_ASSET);
              ...
              _005fjspx_005ftagPool_005fhtml_005fradio_005fvalue_005fproperty_005fnobody.reuse(_jspx_th_html_005fradio_005f1);
              out.write("\r\n                    </td>\r\n                    <td class=\"FormElement\" id=\"");
              out.print(form.ID_ASSET_MATCHING_OVERWRITE_LABEL);
              out.write("\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_OverwriteTheExistingAsset") );
              out.write("\r\n                    </td>\r\n                </tr>\r\n                <tr>\r\n                    <td class=\"FormLabel\" id=\"");
              out.print(form.ID_ITEM_MATCHING_LABEL);
              out.write("\" nowrap=\"true\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_ItemMatching") );
              out.write("\r\n                    </td>\r\n                    <td>&nbsp;</td>\r\n                </tr>\r\n                <tr>\r\n                    <td class=\"FormElement tdAlignRight\">\r\n                        ");
              //  html:radio
              ...
              // /cataloging/scheduleassetimport.jsp(211,24) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fradio_005f2.setProperty(form.FIELD_SKIP_DUPLICATE_ITEMS);
              // /cataloging/scheduleassetimport.jsp(211,24) name = value type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fradio_005f2.setValue(form.VALUE_SKIP_ITEM);
              ...
              _005fjspx_005ftagPool_005fhtml_005fradio_005fvalue_005fproperty_005fnobody.reuse(_jspx_th_html_005fradio_005f2);
              out.write("\r\n                    </td>\r\n                    <td class=\"FormElement\" id=\"");
              out.print(form.ID_ITEM_MATCHING_SKIP_LABEL);
              out.write("\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_SkipTheIncomingItemIfItMatchesAnExistingItemBasedOnTheAssetIdentifierDefinedInYourFileDistrictIdentifierOrBarcode") );
              out.write("\r\n                    </td>\r\n                </tr>\r\n                <tr>\r\n                    <td class=\"FormElement tdAlignRight\">\r\n                        ");
              //  html:radio
              ...
              // /cataloging/scheduleassetimport.jsp(219,24) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fradio_005f3.setProperty(form.FIELD_SKIP_DUPLICATE_ITEMS);
              // /cataloging/scheduleassetimport.jsp(219,24) name = value type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fradio_005f3.setValue(form.VALUE_REPLACE_ITEM);
              ...
              _005fjspx_005ftagPool_005fhtml_005fradio_005fvalue_005fproperty_005fnobody.reuse(_jspx_th_html_005fradio_005f3);
              out.write("\r\n                    </td>\r\n                    <td class=\"FormElement\" id=\"");
              out.print(form.ID_ITEM_MATCHING_OVERWRITE_LABEL);
              out.write("\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_OverwriteTheExistingItemWithTheIncomingItemIfTheAssetIdentifierDefinedInTheFileDistrictIdentifierOrBarcodeAndTheDisplayableAssetNameMatch") );
              out.write("\r\n                    </td>\r\n                </tr>\r\n                <tr>\r\n                    <td class=\"FormElement tdAlignRight\">\r\n                        ");
              //  html:radio
              ...
              // /cataloging/scheduleassetimport.jsp(227,24) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fradio_005f4.setProperty(form.FIELD_SKIP_DUPLICATE_ITEMS);
              // /cataloging/scheduleassetimport.jsp(227,24) name = value type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005fradio_005f4.setValue(form.VALUE_ALWAYS_ADD_ITEM);
              ...
              _005fjspx_005ftagPool_005fhtml_005fradio_005fvalue_005fproperty_005fnobody.reuse(_jspx_th_html_005fradio_005f4);
              out.write("\r\n                    </td>\r\n                    <td class=\"FormElement\" id=\"");
              out.print(form.ID_ITEM_MATCHING_ADD_LABEL);
              out.write("\">\r\n                        ");
              out.print(MessageHelper.formatMessage("scheduleassetimport_AlwaysAddTheIncomingItemRecordAndAssignItTheNextAvailableBarcode") );
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/scheduleassetimport.jsp(64,0) name = strutsErrors type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fshowHideTag_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/scheduleassetimport.jsp(238,12) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fsaveButton_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005fshowHideTag_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/scheduleassetimport.jsp(242,28) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fcancelButton_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005fshowHideTag_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/scheduleassetimport.jsp(245,28) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
