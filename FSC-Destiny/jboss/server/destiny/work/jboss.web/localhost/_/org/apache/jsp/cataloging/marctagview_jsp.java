...
import com.follett.fsc.destiny.session.cataloging.ejb.TitleAED;
...
public final class marctagview_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    String  myForm = request.getParameter("myForm");
      ...
      // /cataloging/marctagview.jsp(29,64) name = indexId type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_logic_005fiterate_005f0.setIndexId("tagIndex");
      // /cataloging/marctagview.jsp(29,64) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_logic_005fiterate_005f0.setId("marcVO");
      // /cataloging/marctagview.jsp(29,64) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_logic_005fiterate_005f0.setName(myForm);
      // /cataloging/marctagview.jsp(29,64) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_logic_005fiterate_005f0.setProperty("marcVOList");
      // /cataloging/marctagview.jsp(29,64) name = type type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      ...
      if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        java.lang.Integer tagIndex = null;
        ...
        tagIndex = (java.lang.Integer) _jspx_page_context.findAttribute("tagIndex");
        do {
          out.write('\r');
          out.write('\n');
          out.write("\r\n     ");
        ...
        if(!StringHelper.isEmptyOrWhitespace(marcVO.getQuizShortSiteName()) && hideLocalQuizzes) {
          ...
          out.write("<tr><td class=\"SmallColRow\" align=\"center\" colspan=\"6\"><a class=\"DetailLink\" href=\"javascript:showQuizRows()\" id=\"");
          out.print(TitleEditForm.ID_SHOW_SPECIFIC_526_TAGS );
          out.write('"');
          out.write('>');
          out.print( MessageHelper.formatMessage("marctagview_ShowSiteSpecific526Tags") );
          out.write(" <img src='");
        ...
        out.println("<tr>");
          ...
          out.write("\r\n        <td valign=\"top\" class=\"SmallColHeading tdAlignRight\" width=\"25%\" rowspan='");
          out.print( rowSpan );
          out.write("'>\r\n\t");
		...
		if(marcVO.isSiteSpecificSubject()) {
          ...
          out.write("\r\n        </td>\r\n\r\n        <td valign=\"top\" width=\"\" class=\"ColRow\" rowspan='");
          out.print( rowSpan );
          out.write('\'');
          out.write('>');
          ...
          out.write('\'');
          out.write('>');
          out.print( StringHelper.replaceSpacesWithNBSP(marcVO.getDisplayableIndicator1()) );
          out.write("</td>\r\n        <td valign=\"top\" class=\"ColRow\" rowspan='");
          out.print( rowSpan );
          out.write('\'');
          out.write('>');
          out.print( StringHelper.replaceSpacesWithNBSP(marcVO.getDisplayableIndicator2()) );
          out.write("</td>\r\n\r\n        <td valign=\"top\" class=\"ColRow\">");
          out.print( ResponseUtils.filter(marcVO.getDisplayableSubfieldCode(0)));
          out.write("</td>\r\n        ");
          ...
          out.write("\r\n        <td valign=\"top\" class=\"ColRow\" width=\"75%\">");
          out.print( data );
          out.write("</td>\r\n\r\n\r\n        </tr>\r\n");
       ...
       for (int i = 1; i < marcVO.getRowCount(); i++) {
          ...
          out.write("\r\n            <td valign=\"top\" class=\"ColRow\">");
          out.print( ResponseUtils.filter(marcVO.getDisplayableSubfieldCode(i)));
          out.write("</td>\r\n");
          ...
          out.write("\r\n            <td valign=\"top\" class=\"ColRow\" colspan=\"4\">");
          out.print( data );
          out.write("</td>\r\n            </tr>\r\n        ");
 } // end of for
        } // end of if (!hideRow)
  ...
  private boolean _jspx_meth_bean_005fwrite_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/marctagview.jsp(54,37) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_bean_005fwrite_005f0.setName("marcVO");
    // /cataloging/marctagview.jsp(54,37) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_bean_005fwrite_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/marctagview.jsp(58,15) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_bean_005fwrite_005f1.setName("marcVO");
    // /cataloging/marctagview.jsp(58,15) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_bean_005fwrite_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/marctagview.jsp(64,74) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_bean_005fwrite_005f2.setName("marcVO");
    // /cataloging/marctagview.jsp(64,74) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
