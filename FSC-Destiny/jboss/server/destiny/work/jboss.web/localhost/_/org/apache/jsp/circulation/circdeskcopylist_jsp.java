...
public final class circdeskcopylist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	ICircDeskCopyList form = (ICircDeskCopyList)request.getAttribute(formName);
      ...
      // /circulation/circdeskcopylist.jsp(24,1) name = indexId type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_logic_005fiterate_005f0.setIndexId("flipper");
      // /circulation/circdeskcopylist.jsp(24,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_logic_005fiterate_005f0.setId("row");
      // /circulation/circdeskcopylist.jsp(24,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_logic_005fiterate_005f0.setName( formName );
      // /circulation/circdeskcopylist.jsp(24,1) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_logic_005fiterate_005f0.setProperty("list");
      // /circulation/circdeskcopylist.jsp(24,1) name = type type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_logic_005fiterate_005f0.setType("com.follett.fsc.destiny.session.circulation.data.CircDeskCopyVO");
      int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
      if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        com.follett.fsc.destiny.session.circulation.data.CircDeskCopyVO row = null;
        ...
        row = (com.follett.fsc.destiny.session.circulation.data.CircDeskCopyVO) _jspx_page_context.findAttribute("row");
        ...
        do {
          ...
          // /circulation/circdeskcopylist.jsp(25,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_logic_005fequal_005f0.setName("flipper");
          // /circulation/circdeskcopylist.jsp(25,3) name = value type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_logic_005fequal_005f0.setValue("0");
          int _jspx_eval_logic_005fequal_005f0 = _jspx_th_logic_005fequal_005f0.doStartTag();
          if (_jspx_eval_logic_005fequal_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              out.write("\r\n\t            <tr>\r\n\t                <td class=\"SmallColHeading\">");
              out.print( MessageHelper.formatMessage("circdeskcopylist_Barcode") );
              out.write("</td>\r\n\t                <td class=\"SmallColHeading\">");
              out.print( MessageHelper.formatMessage("circdeskcopylist_Status") );
              out.write("</td>\r\n\t\t\t\t");
 ...
 if ( form.getCollectionType() == BibMasterSpecs.COLLECTION_TYPE_ASSET ) {
              ...
              out.write("\r\n\t                <td class=\"SmallColHeading\">");
              out.print( MessageHelper.formatMessage("circdeskcopylist_Call") );
              out.write("</td>\r\n\t\t\t\t");
 } 
              out.write("\r\n\t\t\t\t\r\n\t\t\t\t");
 if ( showSiteName ) { 
              out.write("\r\n\t\t\t\t\t<td class=\"SmallColHeading\">");
              out.print( MessageHelper.formatMessage("circdeskcopylist_Site") );
              out.write("</td>\r\n\t\t\t\t");
 } 
              out.write("\r\n\t\t\t\t\r\n\t            </tr>\r\n      ");
 ...
 if (StringHelper.isEmpty(row.getBarcode())) { 
          ...
          out.write("\r\n\t\t\t\t\t\t<a href=\"");
          out.print( form.getCircDeskCopyURL(row) );
          out.write('"');
          out.write('>');
          out.print( ResponseUtils.filter(row.getBarcodeDisplayable()) );
          out.write("</a></td>\r\n\t                ");
 } 
          out.write("\r\n\t\t\t\t\t");
          out.write("\r\n\t                <td class=\"ColRow\">\r\n\t\t\t\t\t\t");
          out.print( ResponseUtils.filter(row.getStatus()) );
          out.write("\r\n\t                </td>\r\n\t\t\t\t");
 if (form.isTextbookMode() || (form.getCollectionType() == BibMasterSpecs.COLLECTION_TYPE_ASSET)) { 
          out.write("\r\n\t\t\t\t\t");
          out.write("\r\n\t                ");
          ...
          // /circulation/circdeskcopylist.jsp(60,17) name = clazz type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005ftd_005f0.setClazz("ColRow");
          // /circulation/circdeskcopylist.jsp(60,17) name = filtered type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          ...
          // /circulation/circdeskcopylist.jsp(62,17) name = clazz type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005ftd_005f1.setClazz("ColRow");
          // /circulation/circdeskcopylist.jsp(62,17) name = filtered type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
 ...
 if(row.getCallNumber()!=null) { 
          ...
          // /circulation/circdeskcopylist.jsp(66,18) name = clazz type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005ftd_005f2.setClazz("ColRow");
          // /circulation/circdeskcopylist.jsp(66,18) name = filtered type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
