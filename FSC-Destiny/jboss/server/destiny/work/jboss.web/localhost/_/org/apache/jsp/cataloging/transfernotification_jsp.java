...
import com.follett.fsc.destiny.client.cataloging.servlet.TransferNotificationForm;
...
public final class transfernotification_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    TransferNotificationForm form = (TransferNotificationForm)request.getAttribute(TransferNotificationForm.FORM_NAME);
      ...
      out.print(TransferNotificationForm.FORM_NAME);
      out.write('.');
      out.print(TransferNotificationForm.PARAM_WHERE_WAS_ENTER);
      out.write(".value=ctrl;                       \r\n            document.");
      out.print(TransferNotificationForm.FORM_NAME);
      out.write('.');
      out.print(TransferNotificationForm.FIELD_TRAP_ENTER_PRESSED);
      ...
      // /cataloging/transfernotification.jsp(41,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setAction("/cataloging/servlet/handletransfernotificationform.do");
      // /cataloging/transfernotification.jsp(41,0) name = focus type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setFocus(TransferNotificationForm.FIELD_DISPLAY_NAME);
      ...
      if (_jspx_eval_base_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /cataloging/transfernotification.jsp(43,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_c_005fif_005f0.setTest( TransferNotificationForm.ACTION_DELETE_EMAIL.equals(form.getAction()) );
          ...
          if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              // /cataloging/transfernotification.jsp(45,9) name = showWarningIcon type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fconfirmBox_005f0.setShowWarningIcon(true);
              // /cataloging/transfernotification.jsp(45,9) name = filterMessage type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fconfirmBox_005f0.setFilterMessage(false);
              // /cataloging/transfernotification.jsp(45,9) name = header type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fconfirmBox_005f0.setHeader("Are you sure you want to delete this email?");
              // /cataloging/transfernotification.jsp(45,9) name = messageText type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fconfirmBox_005f0.setMessageText(form.buildConfirmDeleteMessage());
              // /cataloging/transfernotification.jsp(45,9) name = yesName type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fconfirmBox_005f0.setYesName(TransferNotificationForm.BUTTON_CONFIRM_DELETE);
              // /cataloging/transfernotification.jsp(45,9) name = noName type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fconfirmBox_005f0.setNoName(TransferNotificationForm.BUTTON_CONFIRM_DELETE_NO);
          ...
          // /cataloging/transfernotification.jsp(53,4) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          ...
          // /cataloging/transfernotification.jsp(54,4) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f1.setProperty(TransferNotificationForm.PARAM_WHERE_WAS_ENTER);
          // /cataloging/transfernotification.jsp(54,4) name = value type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          ...
          // /cataloging/transfernotification.jsp(55,4) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f2.setProperty(TransferNotificationForm.FIELD_TRAP_ENTER_PRESSED);
          // /cataloging/transfernotification.jsp(55,4) name = value type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          ...
          // /cataloging/transfernotification.jsp(56,4) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f3.setProperty(TransferNotificationForm.PARAM_EMAIL_ID);
          ...
          // /cataloging/transfernotification.jsp(57,4) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f4.setProperty(TransferNotificationForm.PARAM_NOTICES_FOR_DWSHIPMENT);
          ...
          // /cataloging/transfernotification.jsp(60,1) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setId(TransferNotificationForm.TABLE_MAIN);
          // /cataloging/transfernotification.jsp(60,1) name = borderColor type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setBorderColor("#C0C0C0");
          // /cataloging/transfernotification.jsp(60,1) name = selectedTab type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setSelectedTab(TransferNotificationForm.ID_TAB);
          // /cataloging/transfernotification.jsp(60,1) name = tabs type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setTabs(form.getTabs());
          // /cataloging/transfernotification.jsp(60,1) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
            ...
            do {
              ...
              if (_jspx_eval_c_005fchoose_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  // /cataloging/transfernotification.jsp(64,20) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_c_005fwhen_005f0.setTest(form.isDistrictWarehouseHeaders());
                    ...
                    do {
                      ...
                      if (_jspx_eval_c_005fchoose_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                        do {
                          ...
                          // /cataloging/transfernotification.jsp(66,28) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                    ...
                    do {
                      ...
                      if (_jspx_eval_c_005fchoose_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                        do {
                          ...
                          // /cataloging/transfernotification.jsp(76,28) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              // /cataloging/transfernotification.jsp(87,16) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setName(TransferNotificationForm.BUTTON_ADD_EMAIL );
              // /cataloging/transfernotification.jsp(87,16) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setAlt("Add new email");
              // /cataloging/transfernotification.jsp(87,16) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setSrc("/buttons/large/add.gif");
              // /cataloging/transfernotification.jsp(87,16) name = absbottom type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              if (_jspx_eval_c_005fchoose_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  // /cataloging/transfernotification.jsp(93,20) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_c_005fwhen_005f3.setTest(form.isDistrictWarehouseHeaders());
                    ...
                    do {
                      ...
                      if (_jspx_eval_c_005fchoose_005f4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                        do {
                          ...
                          // /cataloging/transfernotification.jsp(95,28) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                          _jspx_th_c_005fwhen_005f4.setTest(form.getCollectionType() == CollectionType.ASSET);
                    ...
                    do {
                      ...
                      if (_jspx_eval_c_005fchoose_005f5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                        do {
                          ...
                          // /cataloging/transfernotification.jsp(106,28) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              out.print(TransferNotificationForm.TABLE_FIELDS);
              ...
              // /cataloging/transfernotification.jsp(125,19) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f0.setProperty(TransferNotificationForm.FIELD_DISPLAY_NAME);
              // /cataloging/transfernotification.jsp(125,19) name = size type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f0.setSize("30");
              // /cataloging/transfernotification.jsp(125,19) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              // /cataloging/transfernotification.jsp(131,26) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f1.setProperty(TransferNotificationForm.FIELD_TO_EMAIL);
              // /cataloging/transfernotification.jsp(131,26) name = size type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f1.setSize("30");
              // /cataloging/transfernotification.jsp(131,26) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              // /cataloging/transfernotification.jsp(132,26) name = absbottom type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f1.setAbsbottom(true);
              // /cataloging/transfernotification.jsp(132,26) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f1.setSrc("/buttons/large/testemail.gif");
              // /cataloging/transfernotification.jsp(132,26) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f1.setName( TransferNotificationForm.BUTTON_NAME_TEST_EMAIL );
              // /cataloging/transfernotification.jsp(132,26) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              out.print(form.getAccessLevelNeededToReceive());
              out.write(" \r\n            </td>\r\n        </tr>\r\n\t\t");
              //  logic:equal
              ...
              // /cataloging/transfernotification.jsp(143,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_logic_005fequal_005f0.setName( TransferNotificationForm.FORM_NAME );
              // /cataloging/transfernotification.jsp(143,2) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_logic_005fequal_005f0.setProperty( TransferNotificationForm.PARAM_DISPLAY_EMAIL_LIST);
              // /cataloging/transfernotification.jsp(143,2) name = value type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              if (_jspx_eval_logic_005fequal_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.print(TransferNotificationForm.TABLE_EMAIL_LIST );
                  ...
                  // /cataloging/transfernotification.jsp(158,24) name = indexId type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_logic_005fiterate_005f0.setIndexId("flipper");
                  // /cataloging/transfernotification.jsp(158,24) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_logic_005fiterate_005f0.setId("rowSelected");
                  // /cataloging/transfernotification.jsp(158,24) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_logic_005fiterate_005f0.setName(TransferNotificationForm.FORM_NAME);
                  // /cataloging/transfernotification.jsp(158,24) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_logic_005fiterate_005f0.setProperty(TransferNotificationForm.PARAM_EMAIL_LIST);
                  // /cataloging/transfernotification.jsp(158,24) name = type type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  ...
                  if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    do {
                      ...
                      // /cataloging/transfernotification.jsp(159,28) name = key type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                      _jspx_th_base_005fflipper_005f0.setKey("notification");
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f0(PageContext _jspx_page_context)
    ...
    // /cataloging/transfernotification.jsp(40,0) name = strutsErrors type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
