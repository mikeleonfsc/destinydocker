...
import com.follett.fsc.destiny.client.cataloging.servlet.UpdateDocumentForm;
import java.util.*;
import com.follett.fsc.destiny.util.ObjectHelper;
import org.apache.struts.util.ResponseUtils;
import com.follett.fsc.destiny.client.common.jsptag.MessageBoxTag;
import com.follett.fsc.destiny.session.cataloging.ejb.data.DocumentVO;
import com.follett.fsc.destiny.client.backoffice.servlet.JobSummaryForm;
import com.follett.fsc.common.MessageHelper;
import com.follett.fsc.common.LocaleHelper;
import com.follett.fsc.destiny.util.Permission;

public final class updatedocument_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    UpdateDocumentForm form = (UpdateDocumentForm)request.getAttribute(UpdateDocumentForm.FORM_NAME);
      ...
      // /cataloging/updatedocument.jsp(29,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setAction("/cataloging/servlet/handleupdatedocumentform.do");
      ...
      if (_jspx_eval_base_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /cataloging/updatedocument.jsp(30,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f0.setProperty( UpdateDocumentForm.PARAM_COPY_ID );
          ...
          // /cataloging/updatedocument.jsp(31,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f1.setProperty( UpdateDocumentForm.PARAM_BIB_ID );
          ...
          // /cataloging/updatedocument.jsp(34,0) name = name type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_logic_005fnotEmpty_005f0.setName( UpdateDocumentForm.FORM_NAME );
          // /cataloging/updatedocument.jsp(34,0) name = property type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_logic_005fnotEmpty_005f0.setProperty(UpdateDocumentForm.PARAM_DELETE_ID);
          ...
          if (_jspx_eval_logic_005fnotEmpty_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              // /cataloging/updatedocument.jsp(35,4) name = showRedBorder type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              if (_jspx_eval_base_005fmessageBox_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  // /cataloging/updatedocument.jsp(36,2) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_html_005fhidden_005f2.setProperty( UpdateDocumentForm.PARAM_DELETE_ID);
                  ...
                  out.print( MessageHelper.formatMessage("updatedocument_DoYouWantToDelete", ResponseUtils.filter(form.getDeleteName())));
                  ...
                  // /cataloging/updatedocument.jsp(43,16) name = buttonYesName type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005fyesNo_005f0.setButtonYesName(UpdateDocumentForm.BUTTON_CONFIRM_DELETE);
          ...
          // /cataloging/updatedocument.jsp(50,0) name = borderColor type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setBorderColor("#c0c0c0");
          // /cataloging/updatedocument.jsp(50,0) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setId(UpdateDocumentForm.TABLE_OUTLINED);
          // /cataloging/updatedocument.jsp(50,0) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
        ...
        if( form.canAddEditDocumentation()) {
              ...
              // /cataloging/updatedocument.jsp(64,3) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setSrc("/buttons/large/addnew.gif");
              // /cataloging/updatedocument.jsp(64,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setName( UpdateDocumentForm.BUTTON_ADD_NEW );
              // /cataloging/updatedocument.jsp(64,3) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    ...
    if ( iter.hasNext() ) {
              ...
              out.write("\t\t\r\n\t<tr>\r\n\t\t<td colspan=\"2\">\r\n\t\t\t<table id=");
              out.print( UpdateDocumentForm.TABLE_LIST );
 ...
 if (iter.hasNext()) { 
              ...
              // /cataloging/updatedocument.jsp(96,20) name = key type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fflipper_005f0.setKey("updatedocument");
...
flipper=1; 
                  out.write("\r\n    \t\t            <td class=\"ColRow\">");
                  out.print( ResponseUtils.filter(value.getDocumentName()));
                  out.write("</td>\r\n                        <td align=\"center\">\r\n                            ");
 if (value.isAllowMyInfoView()) { 
                  out.write(' ');
                  ...
                  // /cataloging/updatedocument.jsp(105,22) name = page type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005flink_005f0.setPage(form.gimmeJobSummaryLink(value) );
                  // /cataloging/updatedocument.jsp(105,22) name = target type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005flink_005f0.setTarget("view document");
                  // /cataloging/updatedocument.jsp(105,22) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005flink_005f0.setId(UpdateDocumentForm.ID_BUTTON_VIEW + value.getDocumentID() );
                  ...
                  if (_jspx_eval_base_005flink_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    do {
                      ...
                      // /cataloging/updatedocument.jsp(107,26) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                      _jspx_th_base_005fimage_005f1.setSrc("/icons/general/view.gif");
                      // /cataloging/updatedocument.jsp(107,26) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                      _jspx_th_base_005fimage_005f1.setWidth(19);
                      // /cataloging/updatedocument.jsp(107,26) name = height type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                      _jspx_th_base_005fimage_005f1.setHeight(16);
                      // /cataloging/updatedocument.jsp(107,26) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                      _jspx_th_base_005fimage_005f1.setAlt(MessageHelper.formatMessage("updatedocument_View", ResponseUtils.filter(value.getDocumentName())));
                  ...
                  // /cataloging/updatedocument.jsp(113,22) name = page type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005flink_005f1.setPage( form.gimmeEditLink(value));
                  // /cataloging/updatedocument.jsp(113,22) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005flink_005f1.setId(UpdateDocumentForm.ID_BUTTON_EDIT + value.getDocumentID() );
                  ...
                  if (_jspx_eval_base_005flink_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    do {
                      ...
                      // /cataloging/updatedocument.jsp(114,26) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                      _jspx_th_base_005fimage_005f2.setSrc("/icons/general/edit.gif");
                      // /cataloging/updatedocument.jsp(114,26) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                      _jspx_th_base_005fimage_005f2.setWidth(19);
                      // /cataloging/updatedocument.jsp(114,26) name = height type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                      _jspx_th_base_005fimage_005f2.setHeight(16);
                      // /cataloging/updatedocument.jsp(114,26) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                      _jspx_th_base_005fimage_005f2.setAlt(MessageHelper.formatMessage("updatedocument_Edit", ResponseUtils.filter(value.getDocumentName())));
                  ...
                  // /cataloging/updatedocument.jsp(121,26) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005fgenericButton_005f1.setSrc("/icons/general/delete.gif");
                  // /cataloging/updatedocument.jsp(121,26) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005fgenericButton_005f1.setName( UpdateDocumentForm.BUTTON_DELETE_PREFIX + value.getDocumentID());
                  // /cataloging/updatedocument.jsp(121,26) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
                  _jspx_th_base_005fgenericButton_005f1.setAlt( MessageHelper.formatMessage("updatedocument_Delete", value.getDocumentName()) );
    ...
    if (flipper > 0) {
              ...
              // /cataloging/updatedocument.jsp(141,12) name = buttonsToOutput type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fhelpIcons_005f0.setButtonsToOutput( form.gimmeHelpIcons() );
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f0(PageContext _jspx_page_context)
    ...
    // /cataloging/updatedocument.jsp(23,0) name = strutsErrors type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fimageLine_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTable_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/updatedocument.jsp(74,3) name = height type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f0.setHeight("1");
    // /cataloging/updatedocument.jsp(74,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fimage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005fflipper_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/updatedocument.jsp(100,67) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fimageLine_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTable_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/updatedocument.jsp(136,12) name = height type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f1.setHeight("1");
    // /cataloging/updatedocument.jsp(136,12) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
