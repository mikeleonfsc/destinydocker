...
import com.follett.fsc.destiny.client.backoffice.servlet.ExtractPatronInfoForm;
import com.follett.fsc.destiny.session.backoffice.data.ExtractPatronParams;
import com.follett.fsc.common.MessageHelper;

public final class extractpatroninfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    ExtractPatronInfoForm form = (ExtractPatronInfoForm)request.getAttribute(ExtractPatronInfoForm.FORM_NAME);
      ...
      // /backoffice/extractpatroninfo.jsp(24,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setAction("/backoffice/servlet/handleextractpatroninfoform.do");
      ...
      if (_jspx_eval_base_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /backoffice/extractpatroninfo.jsp(25,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f0.setProperty(ExtractPatronInfoForm.PARAM_DROP_DOWN_CHANGE);
          // /backoffice/extractpatroninfo.jsp(25,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          ...
          out.print(ExtractPatronInfoForm.FORM_NAME);
          out.write('.');
          out.print(ExtractPatronInfoForm.PARAM_DROP_DOWN_CHANGE);
          ...
          // /backoffice/extractpatroninfo.jsp(37,0) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setId(ExtractPatronInfoForm.TABLE_MAIN);
          // /backoffice/extractpatroninfo.jsp(37,0) name = borderColor type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTable_005f0.setBorderColor("#C0C0C0");
          int _jspx_eval_base_005foutlinedTable_005f0 = _jspx_th_base_005foutlinedTable_005f0.doStartTag();
          if (_jspx_eval_base_005foutlinedTable_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              out.write("\r\n\r\n<tr>\r\n\t<td class=\"TableHeading\">");
              out.print( MessageHelper.formatMessage("extractpatroninfo_ExtractPatronData") );
              out.write("</td>\r\n</tr>\r\n\r\n<tr>\r\n    <td class=\"TableHeading\">\r\n        <IMG height=\"1\" vspace=\"1\" src=\"/images/icons/general/line.gif\" width=\"100%\">\r\n    </td>\r\n</tr>\r\n\r\n<tr>\r\n\t<td class=\"ColRowBold\">\r\n        ");
              out.print(form.gimmeDropDown());
              out.write("&nbsp;");
              out.print( MessageHelper.formatMessage("extractpatroninfo_From") );
 if ( form.getSelectBy() == ExtractPatronParams.SELECT_BY_HOMEROOM ) { 
              out.write("\r\n        ");
              out.print(form.renderHomeroomDropDown(true) );
              out.write("\r\n        ");
 } else { 
              out.write(" \r\n        ");
              //  html:text
              ...
              // /backoffice/extractpatroninfo.jsp(54,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f0.setProperty( ExtractPatronInfoForm.FIELD_SELECT_BY_START );
              ...
              out.print( MessageHelper.formatMessage("extractpatroninfo_To") );
 if ( form.getSelectBy() == ExtractPatronParams.SELECT_BY_HOMEROOM ) { 
              out.write("\r\n        ");
              out.print(form.renderHomeroomDropDown(false) );
              out.write("\r\n        ");
 } else { 
              out.write(" \r\n        ");
              //  html:text
              ...
              // /backoffice/extractpatroninfo.jsp(58,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_html_005ftext_005f1.setProperty( ExtractPatronInfoForm.FIELD_SELECT_BY_END );
              ...
              // /backoffice/extractpatroninfo.jsp(70,19) name = alt type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericShowHideButton_005f0.setAlt( MessageHelper.formatMessage("extract") );
              // /backoffice/extractpatroninfo.jsp(70,19) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericShowHideButton_005f0.setName(ExtractPatronInfoForm.BUTTON_EXTRACT );
              // /backoffice/extractpatroninfo.jsp(70,19) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f0(PageContext _jspx_page_context)
    ...
    // /backoffice/extractpatroninfo.jsp(19,0) name = strutsErrors type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
