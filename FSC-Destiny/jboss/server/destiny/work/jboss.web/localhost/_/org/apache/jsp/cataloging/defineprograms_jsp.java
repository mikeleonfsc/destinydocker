...
import com.follett.fsc.destiny.client.cataloging.servlet.DefineProgramsForm;

public final class defineprograms_jsp extends org.apache.jasper.runtime.HttpJspBase
...
DefineProgramsForm form = (DefineProgramsForm)request.getAttribute(DefineProgramsForm.FORM_NAME);
      ...
      out.print(DefineProgramsForm.FORM_NAME);
      out.write('.');
      out.print(DefineProgramsForm.PARAM_VIEW_BIB_ID);
      ...
      // /cataloging/defineprograms.jsp(41,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      _jspx_th_base_005fform_005f0.setAction("/cataloging/servlet/handledefineprogramsform.do");
      ...
      if (_jspx_eval_base_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /cataloging/defineprograms.jsp(42,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f0.setProperty(form.FIELD_ADOPTION_YEAR);
          ...
          // /cataloging/defineprograms.jsp(43,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f1.setProperty(form.FIELD_START_DATE);
          ...
          // /cataloging/defineprograms.jsp(44,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f2.setProperty(form.FIELD_END_DATE);
          ...
          // /cataloging/defineprograms.jsp(45,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_html_005fhidden_005f3.setProperty(form.PARAM_VIEW_BIB_ID);
...
if (!form.displayProgramList()){ 
          ...
          // /cataloging/defineprograms.jsp(49,0) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setId(DefineProgramsForm.TABLE_MAIN);
          // /cataloging/defineprograms.jsp(49,0) name = selectedTab type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setSelectedTab(DefineProgramsForm.TAB_DEFINE_PROGRAMS);
          // /cataloging/defineprograms.jsp(49,0) name = tabs type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
          _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0.setTabs(form.getTabs());
          // /cataloging/defineprograms.jsp(49,0) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
...
if (form.displayProgramList()){ 
              out.write("\r\n            <table width=\"100%\" id=");
              out.print(DefineProgramsForm.TABLE_HEADER );
 ...
 if (form.isHaveResults()) { 
              ...
              // /cataloging/defineprograms.jsp(61,24) name = absbottom type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setAbsbottom(true);
              // /cataloging/defineprograms.jsp(61,24) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setSrc("/buttons/large/save.gif");
              // /cataloging/defineprograms.jsp(61,24) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f0.setAlt("Save");
              // /cataloging/defineprograms.jsp(61,24) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              ...
              out.write("\r\n                    </td>\r\n                </tr>                    \r\n                <tr>\r\n                    <td class=\"ColRowBold\" valign=\"top\">\r\n                    These selections determine which titles can be ordered for Pre-order period ");
 ...
 if (!form.isHaveResults()) { 
              ...
              // /cataloging/defineprograms.jsp(124,40) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f1.setSrc("/buttons/small/showless.gif");
              // /cataloging/defineprograms.jsp(124,40) name = absbottom type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f1.setAbsbottom(true);
              // /cataloging/defineprograms.jsp(124,40) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f1.setAlt("Show less");
              // /cataloging/defineprograms.jsp(124,40) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f1.setName(DefineProgramsForm.BUTTON_SHOW_LESS_PREFIX + rec.getProgramID());
              ...
              // /cataloging/defineprograms.jsp(131,40) name = src type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f2.setSrc("/buttons/small/showmore.gif");
              // /cataloging/defineprograms.jsp(131,40) name = absbottom type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f2.setAbsbottom(true);
              // /cataloging/defineprograms.jsp(131,40) name = alt type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f2.setAlt("Show more");
              // /cataloging/defineprograms.jsp(131,40) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
              _jspx_th_base_005fgenericButton_005f2.setName(DefineProgramsForm.BUTTON_SHOW_MORE_PREFIX + rec.getProgramID());
 ...
 if (form.shouldbeChecked(rec.getProgramID())){ 
              ...
              out.print(DefineProgramsForm.FIELD_SELECTED_PROGRAM_PREFIX + rec.getProgramID());
              ...
              out.write("\" cellspacing=\"0\" cellpadding=\"3\">\r\n                                                <!-- Beginning of Third Inner If Else -->\r\n                                                ");
              ...
              out.write("                                                <!-- Beginning of Fourth Inner If Else -->\r\n                                                ");
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f0(PageContext _jspx_page_context)
    ...
    // /cataloging/defineprograms.jsp(30,0) name = strutsErrors type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_base_005fmessageBox_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/defineprograms.jsp(47,4) name = showWarningIcon type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fmessageBox_005f1.setShowWarningIcon(true);
    // /cataloging/defineprograms.jsp(47,4) name = message type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fmessageBox_005f1.setMessage("No Pre-order in progress.");
  ...
  private boolean _jspx_meth_base_005fimageLine_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_base_005foutlinedTableAndTabsWithinThere_005f0, PageContext _jspx_page_context)
    ...
    // /cataloging/defineprograms.jsp(78,24) name = height type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_base_005fimageLine_005f0.setHeight("1");
    // /cataloging/defineprograms.jsp(78,24) name = width type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
