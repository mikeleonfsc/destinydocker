...
<base:form action="/cataloging/servlet/handleauthoritytageditform.do">
...
<tr>
    <td>
        <jsp:include page="/cataloging/basetagedit.jsp">
            <jsp:param name="formName" value="<%= AuthorityTagEditForm.FORM_NAME %>"/>
            <jsp:param name="bibTag" value="false"/>
        </jsp:include>
    </td>
</tr>
</base:outlinedTable>
