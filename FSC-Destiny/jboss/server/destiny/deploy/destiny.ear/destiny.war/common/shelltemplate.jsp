<%@page import="com.follett.fsc.destiny.client.common.jsptag.DestinyHelpLinkTag"%>
<%@page import="com.follett.fsc.destiny.client.common.jsptag.DestinyHelpHelper"%>
...
<table id="<%= BasicSearchForm.TABLE_MENU_INFO %>" border="0" cellpadding="0" cellspacing="0" width="100%" class="mainMenuTable">
  ...
  <tr><!-- row 1 -->
    <td colspan="2">
    <template:get name='persistentmenu'/>
    </td>
  </tr>
  <tr><!-- row 2 -->
   <td></td>
  ...
  <tr><!-- row 3 -->
   <td valign="bottom">
       <template:get name='toplevelmenu'/>
