...
<body>
<H1>UTF-8 Testing Page</H1>

<p>This is a test of your browser compliance with the UTF-8 character set.  Please
...
<form action="/common/dump.jsp" method="POST">

<table border="1" cellpadding="1" cellspacing="0">
  <tr>
    <td colspan="2">
      This case will test the browser's ability to manage <b>diacritics</b>.  Use
      the character map here.  Make certain they match!
    </td>
  </tr>
  <tr>
    <td><%= "\u00c0\u00c8\u00d0\u00d8\u00e0\u00e8\u00f0\u00f8" %></td>
    <td>
      <input name="diacritics" size="20" maxlength="20"/>
    </td>
  </tr>
  <tr>
    <td colspan="2">
      This case will test the browser's ability to manage <b>normal characters</b>.
      Use the keyboard here.  Make certain they match!
    </td>
  </tr>
  <tr>
    <td><%= "ABCabc123!?.(){}" %></td>
    <td><input type="text" property="normal" size="20" maxlength="20"/></td>
  </tr>
  <tr>
    <td colspan="2">
      This case will test the browser's ability to manage <b>latin-a characters</b>.
      Use the character map for some of these and cut and paste for others.
    </td>
  </tr>
  <tr>
    <td><%= "\u0100\u0108\u0110\u0120\u0138\u0140\u017f" %></td>
    <td><input name="latina" size="20" maxlength="20"/></td>
  </tr>
  <tr>
    <td colspan="2">
      This case will test the browser's ability to manage <b>latin-b characters</b>.
      Don't be surprized if they don't look right.  Just copy as they are and paste in
      the edit box.  Some characters might change but just ignore that unless you are using
      Netscape.  Try to be careful to copy just the text displayed.
    </td>
  </tr>
  <tr>
    <td><%= "\u0180\u0188\u0190\u0198\u01a0\u01b0\u01d0\u01f8" %></td>
    <td><input name="latinb" size="20" maxlength="20"/></td>
  </tr>
  <tr>
    <td colspan="2">
      This case will test the browser's ability to manage <b>populated textboxes</b>
      You should be seeing the correct characters already here.
    </td>
  </tr>
  <tr>
    <td><%= "A\u00c0a\u00e0" %></td>
    <td><input name="populated" size="20" maxlength="20"/></td>
  </tr>
  <tr>
    <td colspan="2">
      This case will test the browser's ability to manage <b>precomposed characters</b>.
      Just copy and paste these characters in.  Make certain they match.
    </td>
  </tr>
  <tr>
    <td><%= "n\u0303a\u0309e\u0300i\u0301o\u0304u\u030aA\u0324e\ufe23" %></td>
    <td><input name="precomposed" size="20" maxlength="20"/></td>
  </tr>
  <tr>
    <td colspan="2">
      This case will test the browser's ability to manage <b>fraction characters</b>.  Watch
      to see how these characters are represented.  Some browsers will define 3 physical characters
      to build them.  The first three examples here should be only 3 characters.  The last three
      examples should be 3 characters each separated by spaces.  Copy and paste these in here.
    </td>
  </tr>
  <tr>
    <td><%= "\u00bc\u00bd\u00be 1/3 1/2 1/4 3/4" %></td>
    <td><input name="fractions" size="20" maxlength="20"/></td>
  </tr>
  <tr>
    <td colspan="2">
      This case will test the browser's ability to manage <b>special characters</b>.
      Use the keyboard where possible and the character map for the rest.
    </td>
  </tr>
  <tr>
    <td><%= "!@#$%^&*|~\u00a9\u00a3\u00a2\u00a4\u00a5" %></td>
    <td><input name="special" size="20" maxlength="20"/></td>
  </tr>
</table>
